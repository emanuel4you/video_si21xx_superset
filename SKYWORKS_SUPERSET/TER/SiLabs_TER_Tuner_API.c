 ...
 *************************************************************************************************************/
/***************************************************************************************
                  Skyworks Solutions Broadcast SiLabs_TER_Tuner API
              for easy control of Skyworks Solutions Terrestrial tuners.
...
/* Last changes:
 ...
 As from V0.5.8:
   ...
   (only for TER tuners having this capability, which is the case for most Skyworks TER tuners except Si2173)
 ...
 As from V0.3.7:
    Skyworks TER Tuner wrapper additions for Dual tuners:
 ...
 As from V0.0.2:
  Skyworks tuners supported in initial version:
